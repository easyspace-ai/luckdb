...
import (
	...
	"github.com/easyspace-ai/luckdb/server/internal/domain/sharedb"
	tableRepo "github.com/easyspace-ai/luckdb/server/internal/domain/table/repository"
	"github.com/easyspace-ai/luckdb/server/internal/domain/view"
...
type Adapter struct {
	...
	// fieldRepo  repository.FieldRepository // 实现FieldRepository（暂未集成）
...
func NewAdapter(
	...
	return &Adapter{
		...
		// fieldRepo:  fieldRepo, // 实现FieldRepository（暂未集成）
		viewRepo:  viewRepo,
		tableRepo: tableRepo,
		logger:    logger,
		closed:    false,
