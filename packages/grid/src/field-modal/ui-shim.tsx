...
// Dialog primitives
export const Dialog: React.FC<ShimProps> = ({ children }) => <>{children}</>;
...
// Sheet primitives
export const Sheet: React.FC<ShimProps> = ({ children }) => <>{children}</>;
export const SheetContent: React.FC<ShimProps> = ({ className, children, ...rest }) => (
  <div className={cn('ld-sheet', className)} {...rest}>
    {children}
  </div>
);

// Popover primitives
export const Popover: React.FC<ShimProps> = ({ children }) => <>{children}</>;
